...
s.innerHTML = loader.toString().replace("VER", getVersion()).replace("IPLUG", MAIN.replace(/__EXTENSION_ID__/, chrome.runtime.id).replace("__MENU__", MENU).replace("___URL___", chrome.extension.getURL(""))) + ' loader();';
