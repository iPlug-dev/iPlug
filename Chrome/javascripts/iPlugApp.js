(function () {
    ...
    if (undefined === localStorage["iplug|decolorstring"]) {
        localStorage["iplug|decolorstring"] = "rgb(105,210,231)|rgb(27,103,107/*FIX ME*/";
    }
    ...
    function showMeh() {
        ...
        if (usernames.length > 0)
            plug.tooltip.show(usernames.join("\n"), $("#meh"), false);
    }
