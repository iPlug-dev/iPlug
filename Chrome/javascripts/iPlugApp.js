...
require(["jquery", "underscore", "iplug/youtube-api", "iplug/autowoot", "iplug/version", "sketch", "iplug/utils/tooltip", "iplug/utils/notify", "iplug/utils/dj", "iplug/backgrounds", "iplug/modifications/app-right", "iplug/modifications/playback"], function($, _, ytapi, Autowoot, Version, Sketch, Tooltip, Notify, Dj, backgrounds) {
    "use strict";
    ...
    function checkRealImage(url, callback, sizecallback) {
        ...
        if (/prntscr\.com|prnt\.sc|gyazo\.com|scr\.hu|imgur\.com\/(?!gallery)[^\/]{2,}(?:\/|$)/.test(url) && !/i(?:mage)?\.prnt|i.gyazo\.com|i\.imgur/i.test(url)) {
            needResponse = false;
            img = $("<img/>").attr({
                src: "chrome-extension://__EXTENSION_ID__/images/spinnergrey.png",
                class: "spinning"
            });
            callback({
                image: img,
    ...
    function finishEmotes() {
        ...
        var REGEXUNICODELETTERS = {
            ...
            "n": "[n\\u22C0\\u2AFF\\u2A00\\u2A01\\u2A02\\u2210\\u2AFF\\u22C2\\u019D\\u0272\\u22C0\\u22C1\\u0144\\u0148\\u0146\\u1E4B\\u0235\\u1E45\\u1E47\\u01F9\\u019D\\u0272\\u1E49\\u0220\\u019E\\u0273\\u00D1\\u00F1\\u2210\\u2AFF\\u22C2\\u22C0\\u22C1\\u22C0\\u2A00\\u220F\\u2211\\u2140\\u2A09\\u22C3\\u2AFF\\u22C0\\u2A00\\u22C1\\u220F\\u0273\\u2140\\u2211\\u2A09\\u22C3\\u2AFF\\u2AFF\\u0274\\u057C\\u03B7\\u041B\\u041F]",
            ...
            "e": "[e\\u2B820\\u00C9\\u00E9\\u0115\\u011B\\u0229\\u1E19\\u00CA\\u00EA\\u00CB\\u00EB\\u0117\\u1EB9\\u0205\\u00C8\\u00E8\\u1EBB\\u025D\\u0207\\u0113\\u0119\\u0246\\u0247\\u1E1B\\u1EBD\\uAB30\\u025D\\u025D\\u2130\\u212F\\uD835\\uDC86\\uDCD4\\uDC52\\uDC38\\uDD22\\uDD08\\uDE8E\\uDE74\\uDD56\\uDD3C\\u156E\\u0454\\u0190\\u1D07\\u0045\\u0065\\u0404\\u1D49\\u1D31\\u03B5\\u03A3\\uFF45\\uFF25\\u1653\\u04BD\\u24D4\\u24BA\\u1F14\\u1F1D\\u4E47\\u0AEF\\u025B\\u00A3\\u039E\\u021D\\u0308\\u20AC\\uA085\\u164D\\u0258\\u01DD\\u007C\\u033F\\u0347\\u0336\\u0020\\u0033\\u163F\\u24A0]",
