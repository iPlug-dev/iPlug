...
/////
    ...
    $("#visualsstyle").bind("click", function() {
        ...
        setTimeout(function() {
            $("#visuals" + localStorage['iplug|scvisualsstyle']).css("display", "none");
            localStorage['iplug|scvisualsstyle'] = (1 + parseInt(localStorage['iplug|scvisualsstyle'])) % 2;
            $("#visuals" + localStorage['iplug|scvisualsstyle']).css("display", "block");
