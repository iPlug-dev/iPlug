...
updateColor();
    ...
    $("#now-playing-bar").wrap('<div id="topbarcontainer"></div>').children("#history-button").prependTo("#topbarcontainer").wrap('<div id="iconscontainer"></div>');
